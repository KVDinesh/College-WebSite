...
<html>
	...
	String hallno=(String)session.getAttribute("hallno");
	//String hallno="123";
...
<script type="text/javascript" src="profile.js">
	...
	<body onload="getDisabled(); gender();">
		<!---start-wrap---->
			...
			<tr><td>House Number</td><td><input type="text" name="houseNumber" id="houseNo" pattern="[^'$%*()=|+#!]{1,45}" title="Format: should not contain special charecters except @,-,/ and _ and" value="<%=rs.getString("HOUSENO") %>" required/></td></tr>
			<tr><td>Colony</td><td><input type="text" name="colony" id="colony" pattern="[^'$%*()=|+#!]{1,45}" title="Format: should not contain special charecters except @,-,/ and _ and" value="<%=rs.getString("COLONY") %>" required/></td></tr>
			<tr><td>Address</td><td><input type="text" name="address" id="address" pattern="[^'$%*()=|+#!]{1,45}" title="Format: should not contain special charecters except @,-,/ and _ and" value="<%=rs.getString("ADDRESS") %>" required/></td></tr>
			...
			<input type="button" value="Edit Profile" onclick="getEnabled(); getStates(); getBranch(); getSection();">
			<input type="button" value="Update" id="submit" onclick="sendData()">
